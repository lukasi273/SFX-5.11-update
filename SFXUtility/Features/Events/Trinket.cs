            ...
            try
            {
                ...
                var iItem =
                    ObjectManager.Player.InventoryItems.FirstOrDefault(
                        slot =>
                            slot.IsValidSlot() && slot.IData.ToString().Contains("Trinket", StringComparison.OrdinalIgnoreCase) ||
                            slot.IData.ToString().Contains("Trinket", StringComparison.OrdinalIgnoreCase));
                if (iItem != null)
                {
